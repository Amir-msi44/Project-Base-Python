...
num_games = st.number_input("Enter Number of Simulation", min_value=1, max_value=100000, value=100, step=50)

col1, col2 = st.columns(2)
col1.subheader("Win Percantage without Switching")
col2.subheader("Win Percantage with Switching")
